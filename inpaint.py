...
def inpaint_ligand(model, pdb_file, n_samples, ligand, fix_atoms,
                   add_n_nodes=None, svdd=0, center='ligand', sanitize=False,
    ...
    # print(pocket_com_before)
    # Run sampling
    xh_lig, xh_pocket, lig_mask, pocket_mask = model.ddpm.inpaint(
        ligand, pocket, lig_fixed, svdd, pocket_com_before,model.dataset_info,sanitize,relax_iter,largest_frag, center=center,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--svdd', type=int, default=0)
