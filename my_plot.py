...
# 1. 你的文件路径列表
files = [
    "DiffSBDD/my_example_origion/600_final/out.txt",
    "DiffSBDD/my_example_SPSA/100_30_2_o/out.txt",
    "DiffSBDD/my_example_SVDD/60_15_100_o/out.txt",
    "DiffSBDD/my_example_mix/100_50_10_o/out.txt"
]
...
for metric, (ymin, ymax) in y_limits.items():
    ...
    plt.tight_layout()
    out_path = f"DiffSBDD/my_pic/{metric}_violin_tasks.png"
